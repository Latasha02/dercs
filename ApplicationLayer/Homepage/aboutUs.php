...
<!--Start write the code here-->
  ...
  <table id="detail" height="60%" width="100%"  align="center">
    ...
    <tr>
      <td align="center" colspan="4" height="5%"> <h1 style="color: black;">DERCS</h1>
        <h1> Repairing is Our Job </h1></td>
    </tr>
    <tr>
      <td align="center" width="40%"> <img src="../../Images/map.png" alt="User" width="400" height="350"></td>
      <td align="left" width="60%" style="font-size: 20px">Dercs the computer repair shop is a small company in Kuantan who offer a variety of repairing services, from computer to mobile. </td>
    </tr>
  </table>
  <br>
