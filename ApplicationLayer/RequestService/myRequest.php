...
?> 
  ...
  <tr>
    ...
    <td><input type="button" onclick="location.href='editRequest.php?reqID=<?=$row[RequestID]?>'" value="Edit">&nbsp;<input type="submit" name="delete" value="Delete"></td>
     <td><input type="button" onclick="location.href='viewRequest.php?reqID=<?=$row[RequestID]?>'" value="View"></td>
  </tr>
</table>
</form>
