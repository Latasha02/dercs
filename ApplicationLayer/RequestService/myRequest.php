...
<td><form method="POST" action="">
    <button type="button" onclick="location.href='editRequest.php?reqID=<?=$row['RequestID']?>'" value="Edit"><i class="fa fa-edit"></i></button>&nbsp;&nbsp;<button class="btn" name="delete"><i class="fa fa-trash"></i></button></form></td>
     <td><form method="POST" action="">
      <input type="button" onclick="location.href='viewRequest.php?reqID=<?=$row['RequestID']?>'" value="View"></td>
   </form></td>
