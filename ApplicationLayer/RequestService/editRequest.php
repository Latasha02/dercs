<?php
 ...
 require_once $_SERVER["DOCUMENT_ROOT"].'/dercs/BusinessServicesLayer/RequestServiceController.php';

 $reqID = $_GET['RequestID'];

 $request = new RequestServiceController();
 $data = $request->viewRequest($reqID);
...
<nav class="w3-sidebar w3-bar-block w3-collapse w3-large w3-theme-l5 w3-animate-left" id="mySidebar">
  ...
  <a class="w3-bar-item w3-button w3-hover-black" href="add_request.php">Customer Request</a>
...
<form method="POST" action="">
  <table style="width:100%">
    ...
    <tr>
      ...
      <td><select name="dtype" id="dtype" value="<?=$row['Device_Type']?>">
    ...
    <tr>
      ...
      <td><textarea style="width:200px; height:100px;" type="text" id="message" name="message" value="<?=$row['Message']?>"></textarea> <br><br></td>
    </tr>
</table><br><br>
<input type="submit" id="update" value="Update">&nbsp;&nbsp;&nbsp;
<input type="button" onclick="location.href='myRequest.php'" value="Back">
</form>
