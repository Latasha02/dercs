...
//interface to esit the requested service details
 ...
 $data = $request->viewCustRequest($RequestID);
 //$data2 = $request->viewRequest($cID);

 if(isset($_POST['update'])){
  $request->editCustRequest($RequestID);
 }
  ...
  <table style="width:100%">
    ...
    <tr>
      <td><label for="type">Device Type:</label></td>
       <td><input type="text" id="brand" name="dtype" value="<?=$row['Device_Type']?>" readonly><br><br></td><br><br>
    </tr>
    <tr>
