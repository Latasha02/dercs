...
<form method="POST" action="">
  <table style="width:100%">
    ...
    <tr>
      ...
      <td><textarea style="width:200px; height:100px;" id="messages" name="messages"></textarea> <br><br></td>
    </tr>
</table><br><br>
<input style="background-color: #66b3ff" type="submit" name="request" value="Request">&nbsp;&nbsp;&nbsp;
<input style="background-color: #66b3ff" type="reset" name="reset" value="Clear">
</form>
