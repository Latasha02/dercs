...
<nav class="w3-sidebar w3-bar-block w3-collapse w3-large w3-theme-l5 w3-animate-left" id="mySidebar">
  ...
  <a class="w3-bar-item w3-button w3-hover-black" href="RiderPickupList.php">Pick up from Customer</a>
  <a class="w3-bar-item w3-button w3-hover-black" href="RiderDeliveryList.php">Deliver to Customer List</a>
...
<div class="w3-main" style="margin-left:250px"; width="100%">
  ...
  <div class="w3-row w3-padding-64">
    <div class="w3-full w3-container">
        ...
        <table id="lData" width="100%" width="100%" class="table table-stripped table-bordered" align="center">
          <h1>On the way to pick up</h1>
            ...
            ?>
            <td><form method="POST"> 
                    <input type="hidden" name="DeliveryID" value="<?=$row1['DeliveryID']?>">
        ...
        <table id="kData" width="100%" width="100%" class="table table-stripped table-bordered" align="center">
